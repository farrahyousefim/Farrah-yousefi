    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="container mx-auto px-6 py-16">
        <div className="max-w-5xl mx-auto">
          ...
          <img src={erpProblems} alt="UX problems identified" className="w-full rounded-lg mb-16" />

          {/* Tables redesign */}
          <h3 className="text-[32px] font-['Lustria',serif] text-black mb-4">
            Tables redesign
          </h3>
          <p className="text-[17px] font-['Lustria',serif] text-gray-700 leading-relaxed mb-8">
      ...
      <section className="container mx-auto px-6 py-12">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-[17px] font-['Lustria',serif] text-gray-500 italic mb-12">
            to be continued...
          </p>
          <Link
            to="/"
